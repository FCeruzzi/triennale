 ...
 * @author Francesco
 */
public class ModelloTabellaFootprintsDatabase extends AbstractTableModel {

    private List<Struttura> listaStrutture = new ArrayList<>();

    public ModelloTabellaFootprintsDatabase(List<Struttura> listaStrutture) {
